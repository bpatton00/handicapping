...
function JT_init() {
    ...
    $('a.jt_s').cluetip({ cluetipClass: 'rounded', dropShadow: false, sticky: false, showTitle: true, splitTitle: '|' });
    $('a.jt_s_nt').cluetip({ cluetipClass: 'rounded', dropShadow: false, sticky: false, showTitle: false, splitTitle: '|' });
    $('a.jt_h').cluetip({ cluetipClass: 'jtip', arrows: true, dropShadow: false, hoverIntent: false, closePosition: 'title', titleAttribute: 'name', width: 315, delayedClose: 1, waitImage: false });
